...
void Presenter::drawObject(Rotatable& drawable)
{

    //SDL_RenderCopy(m_main_renderer, drawable.texture, NULL, &drawable.rect);
    SDL_Rect presenterRect = drawable.rect;
    presenterRect.x -= presenterRect.w / 2;
    presenterRect.y -= presenterRect.h / 2;
    SDL_RenderCopyEx(m_main_renderer, drawable.texture, NULL, &presenterRect, drawable.angle, NULL, drawable.flip);
}

void Presenter::drawObject(DrawableSrc& drawable)
{
    SDL_RenderCopy(m_main_renderer, drawable.texture, &drawable.srcRect, &drawable.rect);
}
